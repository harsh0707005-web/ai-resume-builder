    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 py-6">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" className="hidden sm:inline-flex rounded-xl font-medium">Log in</Button>
          <Button size="sm" className="rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-100 flex items-center gap-2 font-semibold">
            Get Started
